document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatableElements.length > 0) {
    ...
    defaultStyles.textContent = [
      '.fade-in, .animate-on-scroll, .scroll-animate, [data-animate] {',
      '  opacity: 0;',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ציוד גיימינג משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a43d9be7-172b-4723-8bca-7785966d350f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a43d9be7-172b-4723-8bca-7785966d350f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a43d9be7-172b-4723-8bca-7785966d350f';
